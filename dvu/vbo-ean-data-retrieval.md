...
| `aud`     | Fixed     | DVU (RVO) organisation identifier `did:ishare:EU.NL.NTRNL-27378529` |
...
|-----------|------|----------|-------------|
| `issuer` | string | Yes | Your organization identifier (`did:ishare:EU.NL.NTRNL-<your KVK>`) |
